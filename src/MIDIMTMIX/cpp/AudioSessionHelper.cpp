...
namespace Common {
	namespace MIXER {
		...
		std::wstring_view AudioSessionHelper::TypeItemsHelper(TypeItems type) {
			switch (type) {
				case TypeItems::TypeSession: return strTypeSession;
				case TypeItems::TypeMaster: return strTypeMaster;
				case TypeItems::TypeDevice: return strTypeDevice;
				case TypeItems::TypeNone: return strTypeNone;
				default: return L"";
			}
		}
		std::wstring_view AudioSessionHelper::OnChangeTypeHelper(OnChangeType type) {
			switch (type) {
				case OnChangeType::OnNoChange: return strOnNoChange;
				case OnChangeType::OnChangeNone: return strOnChangeNone;
				case OnChangeType::OnChangeNew:  return strOnChangeNew;
				case OnChangeType::OnChangeRemove: return strOnChangeRemove;
				case OnChangeType::OnChangeUpdateData: return strOnChangeUpdateData;
				case OnChangeType::OnChangeUpdateVolume: return strOnChangeUpdateVolume;
				case OnChangeType::OnChangeUpdatePan: return strOnChangeUpdatePan;
				case OnChangeType::OnChangeUpdateMute:  return strOnChangeUpdateMute;
				case OnChangeType::OnChangeUpdateAllValues: return strOnChangeUpdateAll;
				case OnChangeType::OnChangeNoCbUpdateData: return strOnChangeNoCbUpdateData;
				case OnChangeType::OnChangeNoCbUpdateVolume: return strOnChangeNoCbUpdateVolume;
				case OnChangeType::OnChangeNoCbUpdatePan: return strOnChangeNoCbUpdatePan;
				case OnChangeType::OnChangeNoCbUpdateMute:  return strOnChangeNoCbUpdateMute;
				case OnChangeType::OnChangeNoCbUpdateAllValues: return strOnChangeNoCbUpdateAll;
				default: return L"";
			}
		}
	}
