    ...
    */
    ...
    #define CENUMERATESERIAL_USE_STL 1
    #define NO_ENUMSERIAL_USING_WMI 1
    #define NO_ENUMSERIAL_USING_COMDB 1
    #define NO_ENUMSERIAL_USING_REGISTRY 1
    #define NO_ENUMSERIAL_USING_SETUPAPI1 1
    #define NO_ENUMSERIAL_USING_CREATEFILE 1
    #define NO_ENUMSERIAL_USING_QUERYDOSDEVICE 1
    #define NO_ENUMSERIAL_USING_GETDEFAULTCOMMCONFIG 1
    ...
    typedef std::vector<UINT> CEnumeratePortsArray;
    typedef std::vector<std::wstring> CEnumerateNamesArray;
