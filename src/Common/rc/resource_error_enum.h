...
namespace Common {
	...
	enum class FLAG_EXPORT common_error_id : int {
		...
		err_MIDIMT_EXEFILTER = 107,
		err_MIDIMT_JSONFILTER = 108,
		err_MIDIMT_CONFFROMFILE = 109,
		err_MIDIMT_CONFFROMDRV = 110,
		err_MIDIMT_LANG_ACTIVE = 111,
		err_MIDIMT_VDRV_VERSION = 112,
		err_REMOTE_START = 113,
		err_REMOTE_STOP = 114,
		err_REMOTE_CLIENT_NEW = 115,
		err_REMOTE_CLIENT_ERR = 116,
		err_REMOTE_CLIENT_CLOSE = 117,
		err_JOY_NODRIVER = 118,
		err_JOY_INVALIDPARAM = 119,
		err_JOY_NOCANDO = 120,
		err_JOY_UNPLUGGED = 121,
		err_JOY_START = 122,
		err_JOY_STOP = 123,
		err_JOY_CHANGE_SCENE = 124,
		err_JOY_CHANGE_CTRL = 125,
		err_COPY_LINK = 126,
		err_NET_IFACE_NONE = 127,
		err_NET_IFACE_SELECT = 128,
		err_TIMEOUT_EXPIRED = 129,
		err_SCRIPT_ERROR = 130,
		err_SCRIPT_EMPTY = 131,
		err_SCRIPT_MODIFY = 132,
		err_SCRIPT_LOADED = 133,
		err_SCRIPT_NOTFOUND = 134,
		err_SCRIPT_START = 135,
		err_SCRIPT_STOP = 136,
		err_SCRIPT_DIRFILTER = 137,
		err_SCRIPT_CALL = 138,
		err_SCRIPT_RESCAN = 139,
		err_SCRIPT_STOPALL = 140,
		err_FILEWATCH_OPEN = 141,
		err_FILEWATCH_PARAM = 142,
		err_FILEWATCH_SHUTDOWN = 143,
		err_FILEWATCH_NOACCESS = 144,
		err_NONE = 145,
