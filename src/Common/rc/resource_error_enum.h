...
namespace Common {
	...
	enum class FLAG_EXPORT common_error_id : int {
		...
		err_MIDIMT_CONFFROMFILE = 108,
		err_MIDIMT_CONFFROMDRV = 109,
		err_MIDIMT_LANG_ACTIVE = 110,
		err_MIDIMT_VDRV_VERSION = 111,
		err_REMOTE_START = 112,
		err_REMOTE_STOP = 113,
		err_REMOTE_CLIENT_NEW = 114,
		err_REMOTE_CLIENT_ERR = 115,
		err_REMOTE_CLIENT_CLOSE = 116,
		err_JOY_NODRIVER = 117,
		err_JOY_INVALIDPARAM = 118,
		err_JOY_NOCANDO = 119,
		err_JOY_UNPLUGGED = 120,
		err_JOY_START = 121,
		err_JOY_STOP = 122,
		err_JOY_CHANGE_SCENE = 123,
		err_JOY_CHANGE_CTRL = 124,
		err_COPY_LINK = 125,
		err_NET_IFACE_NONE = 126,
		err_NET_IFACE_SELECT = 127,
		err_TIMEOUT_EXPIRED = 128,
		err_SCRIPT_ERROR = 129,
		err_SCRIPT_EMPTY = 130,
		err_SCRIPT_MODIFY = 131,
		err_SCRIPT_LOADED = 132,
		err_SCRIPT_NOTFOUND = 133,
		err_SCRIPT_START = 134,
		err_SCRIPT_STOP = 135,
		err_SCRIPT_DIRFILTER = 136,
		err_FILEWATCH_OPEN = 137,
		err_FILEWATCH_PARAM = 138,
		err_FILEWATCH_SHUTDOWN = 139,
		err_FILEWATCH_NOACCESS = 140,
		err_NONE = 141,
