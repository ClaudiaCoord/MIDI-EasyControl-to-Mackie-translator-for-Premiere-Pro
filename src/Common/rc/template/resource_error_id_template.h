...
/* Common::MMKey */
D(IDS_ERRORID_MMKEY_START,		IDS_ERRORID_BASE, 47);
D(IDS_ERRORID_MMKEY_STOP,		IDS_ERRORID_BASE, 48);

/* Common::MQTT */
D(IDS_ERRORID_MQTT_EMPTY_CONFIG,	IDS_ERRORID_BASE, 49);
D(IDS_ERRORID_MQTT_CLIENT_ERROR,	IDS_ERRORID_BASE, 50);
D(IDS_ERRORID_MQTT_CLIENT_OK,		IDS_ERRORID_BASE, 51);
D(IDS_ERRORID_MQTT_CONNECTED,		IDS_ERRORID_BASE, 52);
D(IDS_ERRORID_MQTT_NOT_CONNECTED,	IDS_ERRORID_BASE, 53);
D(IDS_ERRORID_MQTT_DISCONNECTED,	IDS_ERRORID_BASE, 54);
D(IDS_ERRORID_MQTT_NOT_CA_CERT,		IDS_ERRORID_BASE, 55);
D(IDS_ERRORID_MQTT_START,		IDS_ERRORID_BASE, 56);
D(IDS_ERRORID_MQTT_STOP,		IDS_ERRORID_BASE, 57);

/* Common::MIDIMT */
D(IDS_ERRORID_PANEL_INDEX,		IDS_ERRORID_BASE, 58);
D(IDS_ERRORID_PANEL_INIT,		IDS_ERRORID_BASE, 59);
D(IDS_ERRORID_PANEL_ENABLE,		IDS_ERRORID_BASE, 60);
D(IDS_ERRORID_PANEL_NOT_UI_THREAD,	IDS_ERRORID_BASE, 61);
D(IDS_ERRORID_PANEL_NOT_ITEM_VALID,	IDS_ERRORID_BASE, 62);

D(IDS_ERRORID_NONE,			IDS_ERRORID_BASE, 63);
