...
namespace Common {
    ...
    public:
        ...
        static std::wstring to_string(std::runtime_error&);
        static std::wstring to_string(std::exception&);
        static std::wstring to_string(std::error_code&);
        static std::wstring to_string(std::future_error&);
        static std::wstring to_string(std::filesystem::filesystem_error&);
